...
import sty from "./PlasmicIconLink.module.css"; // plasmic-import: zYgNRGyV2nOzdl/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__yWhHi)}
              role={"img"}
            />
          ),
