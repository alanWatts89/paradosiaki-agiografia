...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: 6yeDc8BOoSwsCq/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__s14UI)}>
        <div className={classNames(projectcss.all, sty.freeBox__j0Rw)} />

        <div className={classNames(projectcss.all, sty.freeBox__lu7W)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__nsDlO)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__uxMwf)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__pp0T)}
            >
              <LinkButton
